#' @title Median estimate (using Method 2 of Nhacolo and Brannath, 2018).
#' @description \code{mue2} calculates the median estimate of the response rate.
#' @details This estimate is obtained using the Method 2, one of the four methods proposed by
...
#' @seealso \code{\link{mue1}}, \code{\link{mue2v2}}, \code{\link{mue3}}, \code{\link{aop2}}, \code{\link{aop2e}}, \code{\link{pipv2}}.
#' @export
#' @author Arsenio Nhacolo
mue2 <- function(dsgn, x1o, xo){
  if (x1o == 0) return(0)
  pipv2(dsgn=dsgn, x1o=x1o, xo=xo, pv=0.5)
}
